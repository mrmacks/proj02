 ...
 */
extern void LinkedList_add_at_front(LinkedList *list, char value);

/**
 * Add the given void* value at the end of the given LinkedList.
 */
extern void LinkedList_add_at_end(LinkedList *list, char value);

/**
 * Return true if then given LinkedList contains given void* value.
 */
extern bool LinkedList_contains(const LinkedList *list, char value);
